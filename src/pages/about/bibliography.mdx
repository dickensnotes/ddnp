...
The majority of the manuscripts for Dickens’s Working Notes are held in the Victoria & Albert Museum’s National Art Library in London. The _Our Mutual Friend_ Working Notes are held in the Pierpont Morgan Library in New York. The manuscript of _Great Expectations_, which includes a shorter set of Working Notes, is held by the Wisbech and Fenland Museum in Cambridgeshire. References for the manuscripts that contain complete sets of Working Notes are listed below.
...
This project has also involved archival research with materials including letters and corrected proofs held in the National Art Library’s Forster Collection.
