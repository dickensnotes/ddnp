...
description: "The Dickens Notes project uses a consistent and rigorous editorial methodology in its transcriptions, digital translations, and annotations of the working notes."
---
...
<HowToCite>
  **How to cite this page (MLA)**: Gibson, Anna and Adam Grener. “Editing
  Dickens’s Working Notes.” _Dickens Notes._ Anna Gibson and
  Adam Grener, dirs. 2022. Web. http://dickensnotes.org/about/editing-the-notes/
</HowToCite>

## Editorial Methodology

_Dickens Notes_ aims to cultivate appreciation of the complex and dynamic relationship between Dickens’s working notes and his completed novels. This aim emerges from our recognition of the material richness of the notes, as we have encountered them in their archival setting. While _Dickens Notes_ cannot replicate the materiality of the notes, our methodology leverages the digital environment to translate the materiality of the working notes into an encounter online (for more information about Dickens’s manuscripts, see the [General Introduction](/introduction/general/)).

The _Dickens Notes_ project's presentation of each set of working notes—our transcriptions, as well as our annotations and scholarly introductions—is the result of extensive archival research. Our attention to the manuscript pages of the working notes is supported by careful comparative analysis of the manuscripts and corrected proofs of the novels they accompany.
...
_Dickens Notes_ presents transcriptions of each sheet of working notes as a single image in order to capture Dickens’s use of these pages in the process of composition. In translating the materiality of the working note into a digital image, our transcriptions aim to make the text of each entry clearly legible while also communicating the spatial and visual properties of the working notes.
...
<ImageWithCaption
  ...
  caption="Close-up of the transcription for David Copperfield Working Note No. II; the _Dickens Notes_ transcriptions adjust font size, kerning, and angle to capture the variations in Dickens's handwriting."
/>
...
Version 2.0 was released in June 2026. The project name was changed from the Digital Dickens Notes Project (DDNP) to _Dickens Notes_, and the primary domain was moved from dickensnotes.com to [dickensnotes.org](https://www.dickensnotes.org). Search infrastructure was improved, and website content was updated to reflect the current status of the project.

Version 2.1 was released in August 2026. Assignments and classroom activities were added to a revised "(Teaching with Dickens Notes)[dickensnotes.org/usage/teaching]" page.
