...
Version 1.0 was released in December 2022 with the Working Note transcriptions for _Bleak House_ and _David Copperfield_; a critical introduction and annotations for the _Bleak House_ Working Notes; and complete website content, including general and scholarly introductions. 

Version 1.1 was released in February 2023. Additions included the editorial introduction to, and annotations for, the _David Copperfield_ Working Notes. 

Version 1.2 was released in November 2023. Transcriptions, annotations, and editorial introductions of the Working Notes for _Hard Times_ and _Little Dorrit_ were added.
