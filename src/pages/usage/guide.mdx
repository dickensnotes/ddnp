...
You can access the transcriptions and annotations of the Working Notes for each novel included in the project through the novel’s landing page, which includes a critical introduction to the novel and its Working Notes. The [General Introduction](https://www.dickensnotes.org/introduction/general/) provides an overview of Dickens’s career, the Working Notes, and Victorian seriality. Our [Scholarly Introduction](https://www.dickensnotes.org/introduction/scholarly/) explains how the DDNP intervenes in scholarship on Dickens’s compositional practice and serial form.
...
_To learn more about the technical specifications and design of the DDNP website, visit the [Colophon](https://www.dickensnotes.org/about/colophon/)._
