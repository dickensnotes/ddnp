...
Users can search _Dickens Notes_ with the search tool. Upon searching a keyword, users can subsequently filter results by content type, including site content (introductions and website content), working notes by novel, and annotations for each novel. At this time (V1 release), the keyword search is unable to recognize special characters (e.g. excluding a term, quotations for phrase searching).
