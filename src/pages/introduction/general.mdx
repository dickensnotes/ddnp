...
<ImageWithCaption
  ...
  caption="(Top) Image of the manuscript for Working Note for Bleak House No. XI © Victoria & Albert Museum, London, (Bottom) Dickens Notes offers a legible transcription of the Note while communicating its spatial and visual properties"
  isVA={true}
/>
...
_Read more about the Dickens Notes approach to serial form and Dickens’s compositional practice, as well as our process for transcribing and annotating the notes, in the [Scholarly Introduction](https://www.dickensnotes.org/introduction/scholarly/)._
