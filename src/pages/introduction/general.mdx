...
import ParaWithMarginImage from "/src/components/ParaWithMarginImage.astro";
...
<ImageWithCaption
  src="/images/introduction/Household_Words.jpeg"
  alt="Hard Times in Household Words, 1854"
...
<ParaWithMarginImage
  ...
  alt="Dombey & Son No. V (Feb 1847)"
  caption="Dombey & Son No. V (Feb 1847)"
>
  Dickens’s subsequent novels built on and consolidated this success, and their
  serial publication shaped Dickens’s relationship and popularity with his
  Victorian audience. Although some of his novels were published in weekly
  installments in magazines that Dickens himself edited (such as Hard Times,
  which ran in Household Words from April to August 1854), most of his major
  novels were published in twenty installments that cost one-shilling and
  appeared monthly in their iconic blue-green covers (with the last installment
  being a double number).
</ParaWithMarginImage>
...
<ImageWithCaption
  src="/images/introduction/Little_Dorritt_MS_W4.jpg"
  alt="Working Note for Little Dorrit No. 4, © Victoria & Albert Museum, London"
...
<ImageWithCaption
  src="/images/introduction/Edwin_Drood_MS5_WN5.jpg"
  alt="Unfinished Working Note for The Mystery of Edwin Drood No. 6, © Victoria & Albert Museum, London"
...
<ImageWithCaption
  src="/images/introduction/Working_in_the_NAL.jpeg"
  alt="The National Art Library at the Victoria & Albert Museum in London, Photo by Anna Gibson"
...
<ImageWithCaption
  src="/images/introduction/Our_Mutual_Friend_manuscript.jpeg"
  alt="Our Mutual Friend manuscript, courtesy of the Pierpont Morgan Library (MA 1202-1203)"
