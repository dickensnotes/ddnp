...
<HowToCite>
**How to cite this page (MLA)**: Gibson, Anna, Adam Grener, and Frankie Goodenough. “Scholarly Introduction: Rethinking Dickens’s Serial Form with Dickens Notes.” _Dickens Notes Project._ Anna Gibson and Adam Grener, dirs. 2022. Web. http://dickensnotes.org/introduction/general/

</HowToCite>

## Serial Composition: Writing in Parts

The Dickens Notes Project uses the Working Notes Charles Dickens kept for his novels after 1846 to offer a new approach to the study of these major Victorian texts and the serial form they epitomize. By immersing users in Dickens’s compositional practice over many months of serial writing, and in the iterative development of a serial novel’s form over time, Dickens Notes foregrounds _process_ in reading and analyzing Dickens’s novels.
...
In approaching Dickens’s texts via their temporally expansive composition, Dickens Notes takes seriously the tensions he names between pattern and process, between prospection and retrospection, between complete form and serial formation, between weaving (noun) and weaving (verb).
...
In addition to drawing attention to temporal layers and elements of compositional practice, our annotations also treat the Working Notes as interpretive tools for approaching Dickens’s novels. Notes can illuminate thematic elements of a novel, indicate the relationships between or handling of certain characters, and shed light on pacing and plot developments. Cumulatively, the annotations contribute to Dickens Notes’ efforts to cultivate an appreciation for the dynamism and open-endedness of Dickens’s compositional process, even as his career progressed.
...
As we explain in our [Editorial Methodology](https://www.dickensnotes.org/about/editing-the-notes/), our Project aims to immerse readers in the serial temporality and the material complexity of these compositional documents. Our [User Guide](https://www.dickensnotes.org/usage/guide/) explains how users can explore the Notes in dynamic, non-linear ways to trace, examine, consider, compare, analyze, and experience the Notes in relation to Dickens’s novels.
