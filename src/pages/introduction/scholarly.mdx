...
title: "Scholarly Introduction: Rethinking Dickens's Serial Form with Dickens Notes"
description: "The Dickens Notes project uses transcriptions and editorial annotations of the working notes to immerse users in Dickens's creative process."
twitterTitle: "Rethinking Dickens's Serial Form with the Dickens Notes Project"
twitterDescription: "Scholarly introduction to the Dickens Notes project and Dickens's working notes"
twitterImage: "https://www.dickensnotes.org/images/twitter_cards/IntroCard-with-logo.jpg"
twitterImageAlt: "Photograph of Dickens at his desk in 1853 with the Dickens Notes logo"
---
...
<TOC>
 ...
 - [Exploring Seriality with Dickens Notes: Transcriptions and Annotations](#exploring-seriality-with-dickens-notes-transcriptions-and-annotations)
 - [Dynamic Records of Serial Process: Scholarly Approach](#dynamic-records-of-serial-process-scholarly-approach)
 - [Works Cited](#works-cited)
</TOC>

<HowToCite>
**How to cite this page (MLA)**: Gibson, Anna, Adam Grener, and Frankie Goodenough. “Scholarly Introduction: Rethinking Dickens’s Serial Form with Dickens Notes.” _Dickens Notes._ Anna Gibson and Adam Grener, dirs. 2022. Web. http://dickensnotes.org/introduction/general/

</HowToCite>

## Serial Composition: Writing in Parts

The _Dickens Notes_ project uses the working notes Charles Dickens kept for his novels after 1846 to offer a new approach to the study of these major Victorian texts and the serial form they epitomize. By immersing users in Dickens’s compositional practice over many months of serial writing, and in the iterative development of a serial novel’s form over time, _Dickens Notes_ foregrounds _process_ in reading and analyzing Dickens’s novels.
...
Serial form not only structured Dickens’s compositional habits as a novelist, but it also shaped the contours of his other professional commitments and the rhythms of his personal life. By the time Dickens came to write _Hard Times_ for publication in _Household Words_ in 1854, he found himself needing to conceive and compose the novel—as the working notes vividly illustrate—in the standard monthly installment size he had become accustomed to, before dividing those into smaller segments for weekly publication.
...
In approaching Dickens’s texts via their temporally expansive composition, _Dickens Notes_ takes seriously the tensions he names between pattern and process, between prospection and retrospection, between complete form and serial formation, between weaving (noun) and weaving (verb).
...
The working notes, illuminated by the _Dickens Notes_ annotations, can indeed help us to perceive the “whole pattern” of a long, dense, overpopulated novel via as little as 19 pages of text, drawing attention to the carefully crafted, interwoven threads of plot. But they can also allow us to immerse ourselves in the “finer threads” that weave across, loop back, and interlace between the space and time of serial installments. We can notice as the weaver drops threads, changes his mind, and alters the pattern.

## Exploring Seriality with Dickens Notes: Transcriptions and Annotations

To facilitate this engagement with Dickens’s serial practice, _Dickens Notes_ offers users legible, spatially accurate transcriptions of the working notes with robust editorial annotations.

The _Dickens Notes_ transcriptions aim to translate the materiality of the working notes into digital images. Our transcription practices take into account not just the legible textual content of the notes; we take just as seriously the spatial and visual properties of the page. In rendering non-textual markings (underlining, deletions, and check marks), and in preserving the layout of each manuscript page while making Dickens’s handwriting accessible, we aim to facilitate rich close reading of these compositional records. Immersing readers in Dickens’s multiple engagements with the page, our transcriptions turn these texts into dynamic spaces. Users can zoom in and out of transcriptions to examine the notes in detail and compare the notes’ content across novels. (For more on the creation of our transcriptions, see [Editing the Notes](https://dickensnotes.org/about/editing-the-notes/)).

The _Dickens Notes_ editorial annotations are the product of detailed archival research and provide an immersive engagement with Dickens’s compositional process and serial novel formation. Based on an examination of the working note manuscripts alongside many other archival traces of Dickens’s writing process—including his memoranda book, letters, the densely interlineated novel manuscripts, multiple sets of edited and corrected proofs, and the published installments of each novel—our annotations draw attention to the dynamics of serial composition.
...
In addition to drawing attention to temporal layers and elements of compositional practice, our annotations also treat the working notes as interpretive tools for approaching Dickens’s novels. Notes can illuminate thematic elements of a novel, indicate the relationships between or handling of certain characters, and shed light on pacing and plot developments. Cumulatively, our annotations contribute the project's efforts to cultivate an appreciation for the dynamism and open-endedness of Dickens’s compositional process, even as his career progressed.
...
As we explain in our [Editorial Methodology](https://www.dickensnotes.org/about/editing-the-notes/), _Dickens Notes_ aims to immerse readers in the serial temporality and the material complexity of these compositional documents. Our [User Guide](https://www.dickensnotes.org/usage/guide/) explains how users can explore the notes in dynamic, non-linear ways to trace, examine, consider, compare, analyze, and experience the notes in relation to Dickens’s novels.
