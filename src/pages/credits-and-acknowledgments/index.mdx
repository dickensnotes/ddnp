...
description: "Copyright information and acknowledgment of the individuals and institutions who have supported the  Dickens Notes project."
---

## Credits

All website content and editorial annotations are © _Dickens Notes_ project 2022-2023 unless otherwise credited. This content is licensed under a [Creative Commons CC BY-NC-SA 4.0 License](https://creativecommons.org/licenses/by-nc-sa/4.0/).

The _Dickens Notes_ project is open access. All written material is made available free of charge for individual, non-commercial use only, provided the _Dickens Notes_ project is acknowledged in every instance. Please provide appropriate credit using the citation guidance provided below and on each content page. All work credited to other sources must not be reproduced without permission from the original copyright holder.

The following people have made their original written and technical contributions to the _Dickens Notes_ project: Scott Bailey, Anna Gibson, Frankie Goodenough, Adam Grener, and Isabel Parker (see [Project Team](/about/team/)). Authors and transcribers are cited at the top of each page. Where no author is provided, the work is a collaborative product of the project team led by the project directors, Anna Gibson and Adam Grener. The website was designed by Scott Bailey with assistance from Niqui O’Neill.
...
## How to Cite the _Dickens Notes_ Project

We suggest the following MLA-style citation for _Dickens Notes_, where the material in brackets depends on date of access:

- Anna Gibson and Adam Grener (eds.). _Dickens Notes, version [1.0]. www.dickensnotes.org. Accessed [DATE].
