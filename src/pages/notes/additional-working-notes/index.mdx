...
description: "An overview of Charles Dickens’s complete Working Notes with planned additions to the Dickens Notes Project website content."
---
...
{/* prettier-ignore */}
<TOC>
  - [Expanding the Dickens Notes Project](#expanding-the-dickens-notes-project)
...
<HowToCite>
  **How to cite this page (MLA)**: Gibson, Anna and Adam Grener. “Additional Working Notes.” _Dickens Notes Project_. Anna Gibson and Adam Grener, dirs. 2023. Web. http://dickensnotes.org/notes/additional-working-notes/
</HowToCite>

## Expanding the Dickens Notes Project

The Dickens Notes Project is working to transcribe and annotate all of Charles Dickens’s Working Notes. The project began with the Working Notes for _Bleak House_ (V 1.0, released December 2022), followed by those for _David Copperfield_ (V 1.1, released February 2023). The project expanded to include the Working Notes and annotations for _Hard Times_ and _Little Dorrit_ in November 2023 (V 1.2). 
...
The  Dickens Notes Project Team is at work on transcriptions for _Dombey and Son_, _Our Mutual Friend_, and the unfinished _The Mystery of Edwin Drood_. Our editorial annotations for these Notes are underway, and will help users grasp the progression of Dickens’s note-taking practices over the arc of his career.

<ImageWithCaption
  src="/images/additionalWN/OMF_WN_11_example.webp"
  alt="Working Note for Our Mutual Friend number 11"
  caption="The Working Notes for Our Mutual Friend show Dickens making extensive use of the Notes to document and manage the complexities of the novel's mystery plot; he uses the left-hand side of the Note for No. XI to document the 'Position of affairs' at the mid-point of the novel's serial run."
/>
