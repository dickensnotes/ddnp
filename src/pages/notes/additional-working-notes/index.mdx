...
<HowToCite>
  **How to cite this page (MLA)**: Gibson, Anna and Adam Grener. “Additional Working Notes.” _Digital Dickens Notes Project_. Anna Gibson and Adam Grener, dirs. 2023. Web. http://dickensnotes.com/notes/additional-working-notes/
</HowToCite>

## Expanding the DDNP

The Digital Dickens Notes Project is working to transcribe and annotate all of Charles Dickens’s Working Notes. The project began with the Working Notes for _Bleak House_ (V 1.0, released December 2022), followed by those for _David Copperfield_ (V 1.1, released February 2023). The project expanded to include the Working Notes and annotations for _Hard Times_ and _Little Dorrit_ in November 2023 (V 1.2). 
...
The Digital Dickens Notes Project Team is at work on transcriptions for _Dombey and Son_, _Our Mutual Friend_, and the unfinished _The Mystery of Edwin Drood_. Our editorial annotations for these Notes are underway, and will help users grasp the progression of Dickens’s note-taking practices over the arc of his career.
