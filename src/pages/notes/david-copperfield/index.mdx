...
description: "Dickens Notes provides a critical introduction to the working notes for David Copperfield, with access to transcriptions and editorial annotations in Mirador."
twitterTitle: "Dickens's working notes for David Copperfield at the Dickens Notes project"
...
**Critical Introduction (MLA):** Goodenough, Frankie. “_David Copperfield_ Working Notes: Critical Introduction.” _Dickens Notes_. Anna Gibson and Adam Grener, dirs. 2023. Web. http://dickensnotes.org/notes/david-copperfield/

**The working note transcriptions for David Copperfield (MLA):** Dickens, Charles. "_David Copperfield_ Working Notes," transcribed and edited by Adam Grener and Frankie Goodenough. _Dickens Notes_. Anna Gibson and Adam Grener, dirs. 2022. Web. [http://dickensnotes.org/notes/david-copperfield/mirador/](http://dickensnotes.org/notes/david-copperfield/mirador/)
...
<ImageWithCaption
  ...
  caption="Book Prospectus for David Copperfield, 1849 © John Johnson Collection of Printed Ephemera, Bodleian Library, Oxford (Book Prospectus 12[55]); http://johnjohnson.chadwyck.co.uk/"
/>
